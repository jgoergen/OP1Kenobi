...
class Drums():
    ...
    def __init__(self, core, audio, video, input):
        ...
        self.g = 0
        self.currentIndex = 0
        self.lastDirectories = [Config.OP1USBMountDir + "/drum"]
        ...
        if self.op1Present:
            ...
            if self.menu == 1:
                ...
                if k1:
                    ...
                    if self.local:
                        targetDirectory = Config.OP1USBMountDir + "/drum/"
                        path = path.replace(Config.MediaDirectory + "/drums/", "")
                    else:
                        targetDirectory = Config.MediaDirectory + "/drums/"
                        path = path.replace(Config.OP1USBMountDir + "/drum/", "")

                    self.core.ForceDirectory(targetDirectory + path)

                    # copy
                    print("Drums:: Copying file " + currentObject)
                    print("Drums:: To " + targetDirectory + path + "/" + self.currentFileName)
                    self.core.CopyFile(
                        currentObject,
                ...
                if k2:
                    if self.local:
                        ...
                        self.local = True
                        self.lastDirectories = [Config.MediaDirectory + "/drums"]
